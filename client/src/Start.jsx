 ...
 */    fontFamily:"'Major Mono Display', monospace",
  ...
  return (
    <div style={divStyle} className='bg-cyan-500 h-screen flex flex-col items-center justify-center'>
      <div style={textStyle2} className="text-white text-6xl mb-5"> KASHITOKARU</div>
      <div className="text-cyan-200 text-6xl text-center " style={textStyle}>
